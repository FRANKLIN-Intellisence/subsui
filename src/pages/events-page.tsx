...
const EventRegistrationPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white" style={{
      backgroundImage: "linear-gradient(rgba(0,0,0,0.85), rgba(0,0,0,0.85)), url('/api/placeholder/1400/800')",
      backgroundSize: "cover",
      backgroundPosition: "center"
    }}>
      {/* Top Navigation Bar */}
      <header className="p-4 flex justify-between items-center">
        <div className="text-2xl font-bold">SubSui<span className="text-gray-500">*</span></div>
        <div className="flex items-center gap-6">
          <div className="text-gray-300">14:40 GMT+1</div>
          ...
          <button className="px-4 py-2 rounded-md border border-gray-600 hover:bg-gray-800">connect wallet</button>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row gap-8">
          ...
          <div className="bg-gray-900 rounded-lg overflow-hidden p-6 relative">
            <div className="flex items-center gap-2 mb-4">
              <div className="bg-white text-black py-1 px-3 rounded-md flex items-center text-sm">
                <img src="/api/placeholder/20/20" alt="SUI logo" className="w-5 h-5 mr-1" />
                SUI ON CAMPUS
              </div>
              <div className="bg-blue-600 text-white py-1 px-3 rounded-md text-sm">HACKATHON</div>
            </div>
            
            <h2 className="text-4xl font-bold mb-2">Uniuyo <span className="text-blue-400">Sui</span></h2>
            <h2 className="text-4xl font-bold mb-4">Buildathon</h2>
            
            <div className="bg-blue-600 inline-block px-3 py-1 rounded text-sm mb-8">ROAD TO OVERFLOW</div>
            
            <div className="mb-4">
              <div className="flex items-center mb-2">
                <div className="w-8 h-8 bg-blue-600 text-white flex items-center justify-center rounded-md mr-2">7th</div>
                <span>& 8th March, 2025.</span>
              </div>
              
              <div className="flex items-center mb-4">
                <div className="w-8 h-8 bg-blue-600 text-white flex items-center justify-center rounded-md mr-2">10</div>
                <span>am</span>
                <div className="w-8 h-8 bg-blue-600 text-white flex items-center justify-center rounded-md mx-2">U</div>
                <span>Uniuyo</span>
              </div>
            </div>
        ...
        <div className="md:w-3/5">
          ...
          <div className="mb-8">
            <div className="flex items-center mb-2">
              <div className="bg-gray-800 rounded-full px-2 py-1 mr-4 text-xs inline-block">MAR<br />7</div>
              <div>
          ...
          <div className="bg-gray-900 rounded-lg p-6 mb-8">
            ...
            <p className="mb-6">Welcome! To join the event, please register below.</p>
            <button 
          ...
          <div className="mb-8">
            ...
            <div className="flex mb-4">
              {[...Array(10)].map((_, i) => (
                <div key={i} className="w-6 h-6 bg-red-600 rounded-md flex items-center justify-center text-xs mr-1">
                  🔥
                </div>
              ))}
            </div>
            
            <div className="text-xl font-bold mb-4">SUI ON CAMPUS BUILDERTHON UNIUYO</div>
            
            <p className="mb-4">
              We are pleased to announce a 2-DAY Sui On Campus Buildathon (Road to 
              overflow) at the University of Uyo coming up on 7th and 8th March 2025.
            </p>
            <p>
              It offers a unique opportunity for fifty (50) developers to collaborate and build
              innovative projects using the Sui blockchain technology.
            </p>
          </div>
        </div>
      </div>
